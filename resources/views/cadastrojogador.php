  ...
  <body>
    ...
    <div class="container">
      <form role="form" method="get" action="#">
        <div class="form-group">
          <label for="fullName">Id do aluno</label>
          <input type="int" class="form-control" id="fullName" placeholder="Enter" />
        </div>
        <div class="form-group">
          <label for="matricula">Id do time</label>
          <input type="int" class="form-control" id="matricula" placeholder="Enter" />
        </div>        
