  ...
  <div class="container">
    <form role="form" method="get" action="#">
      <div class="form-group">
        ...
        <input type="email" class="form-control" id="fullName" placeholder="Nome da Atlética" />
      </div>
      <div class="form-group">
        <label for="alunoId">Presidente</label>
        <input type="string" class="form-control" id="alunoId" placeholder="Presidente da Atlética" />
      </div>
      <div class="form-group">
        <label for="logo">Logo da Atlética</label>
